...
namespace L01PO2_2020VR650.Controllers
{
    public class ComentariosController : Controller
    {
        ...
        public ComentariosController(blogDBContexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Comentarios != null ? 
                          ...
                          Problem("Entity set 'blogDBContexto.Comentarios'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'blogDBContexto.Comentarios'  is null.");
            }
            var comentarios = await _context.Comentarios.FindAsync(id);
            if (comentarios != null)
            {
