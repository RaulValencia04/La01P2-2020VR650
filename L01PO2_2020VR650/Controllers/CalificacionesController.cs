...
namespace L01PO2_2020VR650.Controllers
{
    public class CalificacionesController : Controller
    {
        ...
        public CalificacionesController(blogDBContexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Calificaciones != null ? 
                          ...
                          Problem("Entity set 'blogDBContexto.Calificaciones'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'blogDBContexto.Calificaciones'  is null.");
            }
            var calificaciones = await _context.Calificaciones.FindAsync(id);
            if (calificaciones != null)
            {
